...
Enhance your workflows with powerful Git functionality like file annotations, commit history exploration, repository views, and comparison commands—all fully customizable within VS Code.
...
**GitLens Community** is free and gives you powerful tools to manage Git and understand how your code has evolved and by whom. Explore repository history, inspect commits, compare revisions, navigate file and line history, and use on-demand file annotations to understand changes without leaving VS Code.
...
- [**Interactive Code History**](#interactive-code-history) &mdash; Understanding code in repositories with multiple branches and contributors can be difficult. GitLens provides the context you need with file annotations, commit details, repository views, and history navigation.

- [**Navigate Revisions**](#revision-navigation) &mdash; Move through file history, compare revisions, and inspect changes over time.

- [**Manage Repositories**](#side-bar-views) &mdash; Use focused side bar views for commits, branches, remotes, stashes, tags, contributors, repositories, and worktrees.
...
Understanding who made changes, when, and why can be challenging. GitLens simplifies this with Inspect, file annotations, and history views that give you clear context and actionable Git details.
...
Quick access to many GitLens features, help, and support.
...
- **Worktrees** &mdash; Simultaneously work on different branches of a repository.
...
Context switching kills productivity. GitLens reveals buried knowledge within your repository and can link external references in commit messages.

Simplify your workflow with automatic linkification for issue and pull request references across configured Git remotes and custom autolinks.
