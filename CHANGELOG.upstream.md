# Upstream Change Log (Archive)

Historical changelog of the upstream GitLens project (v18.1.0 and earlier), preserved for reference.
WeGit-era changes live in [CHANGELOG.md](CHANGELOG.md) (from v18.2.0 onward).
